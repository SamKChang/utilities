...
$l = $ARGV[2];
$ZV = (1-$l)*$ZV1 + $l*$ZV2;
for ($i=0;$i<3;$i++){$Rlc[$i] = (1-$l)*$Rlc1[$i] + $l*$Rlc2[$i]};
for ($i=0;$i<3;$i++){$Rnl[$i] = (1-$l)*$Rnl1[$i] + $l*$Rnl2[$i]};
for($n=0;$n<3;$n++){
   for($i=1;$i<=3;$i++){
      for($j=1;$j<=3;$j++){
         $h1= $H1[$n][$i][$j];
...
2                                    LMAX
  $Rlc[0]                                     RC
  2 $Rlc[1] $Rlc[2] #C C1 C2
  $Rnl[0] 2 $H[0][1][1] $H[0][1][2] $H[0][2][2] H(s) 11 12 22 
  $Rnl[1] 2 $H[1][1][1] $H[1][1][2] $H[1][2][2] H(s) 11 12 22
  $Rnl[2] 1 $H[2][1][1] H(s) 11
&END\n";
